...
const PowerOffScreen: React.FC = (): ReactElement => {
  return (
    <div className="w-screen h-screen overflow-hidden bg-black flex items-center justify-center m-auto">
      <svg
        ...
        // style="enable-background:new 0 0 198.715 198.715;"
      >
        <g>
